#ifndef UTJSAMPLE_LIT_META_PASS_INCLUDED
#define UTJSAMPLE_LIT_META_PASS_INCLUDED
...
// Vertex function
Varyings LitMetaVert(Attributes input)
{
    Varyings output;
...
// Fragment function
half4 LitMetaFrag(Varyings input) : SV_Target
{
    half4 color;
